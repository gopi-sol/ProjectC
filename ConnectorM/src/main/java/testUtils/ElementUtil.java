...
public class ElementUtil {
	...
	public WebElement getElement(By locator) {
		...
		try {
			...
			test.log(LogStatus.FAIL,"Could not Process...");
...
return format;
	...
	public void doSelectValuesByVisibleText(By locator, String value,String value1){
	...
	public List<WebElement> visibilityOfAllElements(List<WebElement> locator, int timeOut){
		WebDriverWait wait = new WebDriverWait(driver, timeOut);
	...
	public void waitForElementToBeClickable(List<WebElement> findElements) {
